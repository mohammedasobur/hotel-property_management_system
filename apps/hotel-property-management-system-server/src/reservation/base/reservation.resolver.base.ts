...
export class ReservationResolverBase {
  ...
  async getGuest(@graphql.Parent() parent: Reservation): Promise<Guest | null> {
  ...
  async AddNewBooking(
    ...
    return this.service.AddNewBooking(args);
  }
  ...
  async CheckInGuest(
    ...
    return this.service.CheckInGuest(args);
  }
  ...
  async CheckOutGuest(
    ...
    return this.service.CheckOutGuest(args);
  }
