...
@InputType()
class ReservationCreateNestedManyWithoutGuestsInput {
...
export { ReservationCreateNestedManyWithoutGuestsInput as ReservationCreateNestedManyWithoutGuestsInput };
